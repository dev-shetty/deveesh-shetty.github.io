function Art({ title, img }) {
  return (
    <div className="polaroid flex flex-col min-w-[33.33%] md:min-w-[16%] -sm:min-w-[45%] bg-primary-100 odd:rotate-6 even:-rotate-12 shadow-[#DDDDDD] shadow-md rounded-lg -md:shadow-md border-2 border-primary-800 -md:even:-rotate-6">
